...
public class Edge{
  ...
  */
  public Edge(GraphNode pVertex, GraphNode pAnotherVertex, double pWeight){
  ...
  /**
  * Die Anfrage gibt die beiden Knoten, die durch die Kante verbunden werden, als neues Feld vom Typ GraphNode zurueck. Das Feld hat 
  * genau zwei Eintraege mit den Indexwerten 0 und 1.
  */
  public GraphNode[] getVertices(){
    GraphNode[] result = new GraphNode[2];
    result[0] = vertices[0]; 
    result[1] = vertices[1];
    return result;
  }
  ...
  */
  ...
  {
      String s="ID1: "+vertices[0].getID()+" ID2: "+vertices[1].getID()+" Gewicht: "+weight;
      return s;
  }
